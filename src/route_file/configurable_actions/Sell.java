...
public class Sell implements GameActionConfigurable, GameActionPerformable {
	private static final ParsableList<ArgumentFormat> args = new ParsableList<ArgumentFormat>(
		new ArgumentFormat(Integer.class, ArgumentNecessity.OPTIONAL, "quantity"),
    ...
    public String toString() {
    	return String.format("%s %d %s", Sell.class.getSimpleName(), this.quantity, this.item);
    }
}
